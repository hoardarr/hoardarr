...
build_native () {
    dotnet run -p CreateNativeMap/CreateNativeMap.csproj -c "$CONFIGURATION" --library=MonoFuseHelper "Mono.Fuse.NETStandard/bin/$CONFIGURATION/netstandard2.1/Mono.Fuse.NETStandard.dll" buildlibs/map
